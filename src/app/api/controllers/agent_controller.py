...
OPENSTACK_KNOWLEDGE_BASE = [
    ...
    {
        "file": "nova/compute/resource_tracker.py",
    ...
    {
        "file": "nova/scheduler/filter_scheduler.py",
...
@router.post("/agents/find-fault-target")
async def find_fault_target(request: dict):
    ...
    try:
        ...
        {{
            ...
            "fault_type": "tipo de falha sugerida (exception, return_error, timeout, etc)",
            "confidence": 0.95
        }}
        """
